...
**[Directories เบื้องต้น](#Directories%20เบื้องต้น)**

**[การแตกไฟล์](#การแตกไฟล์)**

**[การตั้งค่า](#การตั้งค่า)**

**[การตั้งค่า Access Controls](#การตั้งค่า%20Access%20Controls)**

**[การอัพเกรด](#การอัพเกรด)**

**[การติดตั้งบน Windows](#การติดตั้งบน%20Windows)**

**[FAQ](#faq)**

##  Directories เบื้องต้น
...
#### ขั้นที่ 6
ท่านจะได้รับคำแนะนำการติดตั้ง Apache web server เราแนะนำให้ท่านปรินท์คำแนะนำนี้ไว้เผื่อต้องใช้ในภายหลัง โดยคำแนะนำในขั้นตอนนี้จะบอกไห้ท่าน ...................... ซึ่งท่านสามารถทำใด้โดยการใส่ file `.htaccess` เข้าไปใน directory ดังกล่าว หรือ จากการเปลี่ยนแปลง configuration ของ apache ก็ได้เช่นกัน
